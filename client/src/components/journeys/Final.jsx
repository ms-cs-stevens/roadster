...
const Final = (props) => {
    ...
    async function fetchData() {
      ...
      try {
        const { data } = await axios.get(
          `http://localhost:4000/journeys/${id}`
        );
  ...
  const pdfGenerate = () => {
    html2canvas(document.getElementById("journey"), {
      proxy: "server.js",
      useCORS: true,
    ...
    <div>
      ...
      <div id="journey" className="journey">
        ...
        <dl>
          ...
          <dd>
            {source.locality} {source.state}, {source.country}
          </dd>
          ...
          <dd>
            {destination.locality} {destination.state}, {destination.country}
          </dd>
